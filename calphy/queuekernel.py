...
def run_calculation(job):
    ...
    elif job.calc.mode == "adaptive_ts":
        job = routine_adaptive_ts(job)
    else:
        raise ValueError(
            "Mode should be either fe/ts/mts/alchemy/melting_temperature/tscale/pscale/composition_scaling/adaptive_ts"
        )
    return job
